...
insert into concentracoes (conc_nome, conc_descricao,conc_data,conc_coordenadas, conc_tipo,conc_creator_id ) values('Hondas do aço','Concentracao de hondas do aço','2020-11-05','38.788383, -9.093056',1, 2);
insert into concentracoes (conc_nome, conc_descricao,conc_data,conc_coordenadas,conc_tipo,conc_creator_id ) values('BMWs do porto','Concentracao de BMWs','2020-11-11','41.183631, -8.56538',1 ,1);
...
insert into concentracoescarros(conc_car_conc_id, conc_car_car_id) VALUES (1,1);